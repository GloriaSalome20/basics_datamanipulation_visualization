...
Filtering observations based on their values can be done with the filter() function. This function works on both quantitative and qualitative variables. with syntax of :\\ filter(data , ....)
